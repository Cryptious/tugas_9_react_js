  ...
  render (){
    const munculPopover =
      <Popover title="informasi">
        Website ini dibuat untuk memudahkan dalam pencarian informais terkini tentang berita olahraga
      </Popover> ;
    return (
      <Container fluid>
          ...
          <Col xs={9}>
            ...
            <Row>
              <Tabs defaultActiveKey="semua-transfer" id="uncontrolled-tab-example">
                <Tab eventKey="semua-transfer" title="Semua Transfer" Active>
                </Tab>
                ...
                <Tab eventKey="liga-indonesia" title="Liga 1 Indonesia">
                </Tab>
              </Tabs>
            </Row>
            <br />
